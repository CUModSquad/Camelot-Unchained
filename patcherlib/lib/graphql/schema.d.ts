/** ShardID */
export declare type ShardID = any;
...
export declare type Decimal = any;
/** CU.Groups.InviteCode */
export declare type InviteCode = any;
/** CU.Groups.TargetID */
export declare type TargetID = any;
/** CU.Groups.GroupID */
export declare type GroupID = any;
/** CSEUtilsNET.NormalizedString */
export declare type NormalizedString = any;
/** CU.Stat */
export declare type Stat = any;
/** CU.CharacterID */
export declare type CharacterID = any;
/** CU.Skills.SkillID */
export declare type SkillID = any;
/** CSE.EntityID */
export declare type EntityID = any;
/** CU.ScenarioInstanceID */
export declare type ScenarioInstanceID = any;
/** CU.RoundInstanceID */
export declare type RoundInstanceID = any;
/** CU.ScenarioTeamID */
export declare type ScenarioTeamID = any;
/** CU.RoleID */
export declare type RoleID = any;
/** ItemInstanceID */
export declare type ItemInstanceID = any;
/** CU.ItemStackHash */
export declare type ItemStackHash = any;
/** CU.Databases.Models.ContainerDrawerID */
export declare type ContainerDrawerID = any;
/** CU.Buildings.BuildingPlotInstanceID */
export declare type BuildingPlotInstanceID = any;
/** World.StatusID */
export declare type StatusID = any;
/** CSE.Account.AccountID */
export declare type AccountID = any;
/** CU.Databases.Models.Progression.Logs.CharacterDaySummaryInstanceID */
export declare type CharacterDaySummaryInstanceID = any;
/** CU.Databases.Models.Progression.Logs.ShardDaySummaryInstanceID */
export declare type ShardDaySummaryInstanceID = any;
/** CU.Databases.Models.Items.ItemQuality */
export declare type ItemQuality = any;
/** CU.Databases.Models.ResourceNodeInstanceID */
export declare type ResourceNodeInstanceID = any;
/** CU.Databases.Models.Items.SecureTradeInstanceID */
export declare type SecureTradeInstanceID = any;
...
export interface CUQuery {
    ...
    invites: (Invite | null)[] | null /** Get group invites. Arguments: shard (required), forGroup (optional), toGroup | toCharacter (optional and exclusive, if both are provided, toGroup will be used). */;
    ...
    myPassiveAlerts: (PassiveAlert | null)[] | null /** Alerts that notify players something happened but do not need to be reacted to. */;
...
export interface Trait {
    ...
    prerequisites: (string | null)[] | null /** THIS CURRENTLY RETURNS NULL. List of trait id's that are required to be selected in order to select this trait */;
    ranks: (string | null)[] | null /** THIS CURRENTLY RETURNS NULL. List of trait id's that act as pointers to different ranks of a trait */;
...
export interface ScenarioSummaryDBModel {
    ...
    teamOutcomes: (TeamOutcomeScenarioField | null)[] | null /** details for what the each team did for the whole scenario */;
...
export interface ItemDefRef {
    ...
    tags: (string | null)[] | null /** Tags on this item, these can be referenced by recipes */;
...
export interface GearSlotSet {
    gearSlots: (GearSlotDefRef | null)[] | null /** A list of gear slots which makes up a valid set of places a item can be equipped on at once. */;
}
...
export interface GearSlotDefRef {
    ...
    subpartIDs: (SubpartId | null)[] | null /** Which body subparts this slot belongs to */;
}
...
export interface Item {
    ...
    voxItems: (Item | null)[] | null /** items contained within the vox job of this item */;
...
export interface CharacterProgressionData {
    ...
    adjustmentsByDayLogID: (CharacterAdjustmentDBModel | null)[] | null /** A character adjustments for a specific day log for this character. */;
    characterDays: (CharacterDaySummaryDBModel | null)[] | null /** Information about what happened for this player over the date range provided. */;
    characterAdjustments: (CharacterAdjustmentDBModel | null)[] | null /** Information about what adjustments happened for this player over the date range provided. */;
...
export interface CharacterSummary {
    secondsActive: number | null /** How many seconds of the game have been played by all characters ever for this shard. */;
...
export interface EntityItemResult {
    items: (Item | null)[] | null /** List of items contained within this item.  This includes wrapped items, inventory, and equipment items */;
}
...
export interface GameDefsGQLData {
    ...
    raceStatMods: (RaceStatBonuses | null)[] | null /** Stat modifiers that are applied additively to the base stat value for each Race */;
}
...
export interface CraftingRecipes {
    ...
    recipesMatchingIngredients: (string | null)[] | null /** ID's of recipes which match the current ingredient list in the vox */;
    possibleIngredients: (Item | null)[] | null /** List of inventory items compatible with the current vox job */;
    possibleIngredientsWithSlots: (PossibleVoxIngredientGQL | null)[] | null /** List of inventory items compatible with the current vox job */;
    possibleItemSlots: (SubItemSlot | null)[] | null /** List of sub item slots this vox job uses */;
    blockRecipes: (BlockRecipeDefRef | null)[] | null /** List of recipes for the Block vox job */;
    purifyRecipes: (PurifyRecipeDefRef | null)[] | null /** List of recipes for the Purify vox job */;
    grindRecipes: (GrindRecipeDefRef | null)[] | null /** List of recipes for the Grind vox job */;
    shapeRecipes: (ShapeRecipeDefRef | null)[] | null /** List of recipes for the Shape vox job which have been discovered by the player.  Shape recipes are discovered when the right combination of materials are added to a vox during a shape job. */;
    makeRecipes: (MakeRecipeDefRef | null)[] | null /** List of recipes for the Make vox job */;
}
/** World.VoxStatus */
export interface VoxStatus {
    ...
    voxHealthCost: number | null /** How much damage the vox will take from performing this job. */;
    outputItems: (Item | null)[] | null /** The list of all items which will be rewarded when the vox job is completed.  This information is only available is job is fully configured and ready to run */;
    ...
    recipeID: string | null /** The ID of the recipe which will be performed.  This could be one of serveral types of recipes depending on the vox job type */;
    endQuality: Decimal | null /** The player specified end quality for a substance. Only for Purify jobs */;
    usedRepairPoints: number | null /** How many repair points will be used when repairing the item. Only for Repair jobs */;
    ...
    ingredients: (Item | null)[] | null /** A list of all ingredients that are currently stored in the vox.  These are destroyed at the end of the job */;
...
export interface BlockRecipeDefRef {
    ...
    ingredients: (RecipeIngredientDef | null)[] | null /** Ingredient rules for crafting the item */;
}
...
export interface RecipeIngredientDef {
    ...
    requirementPath: string | null /** Extra requirements on the item, not used if the ingredient is provided. */;
...
export interface MakeIngredientDef {
    ...
    requirementDescription: string | null /** Additional requirements for the ingredient */;
    minQuality: Decimal | null /** The minimum quality the ingredient must be.  Value is 0-1 */;
    maxQuality: Decimal | null /** The maximum quality the ingredient must be.  Value is 0-1 */;
    unitCount: number | null /** How many of this item are required to create one copy of the output item */;
}
...
export interface PlayerCountsplayerCountsArgs {
    ...
    until: string | null /** Time until which to get metrics. See http://graphite-api.readthedocs.io/en/latest/api.html#from-until for more info. (default: now) */;
}
...
export declare enum ScenarioResolution {
    Started = "Started",
    Finished = "Finished",
    Restarted = "Restarted",
    Killed = "Killed"
...
export declare enum ScenarioOutcome {
    Invalid = "Invalid",
    Win = "Win",
    Lose = "Lose",
    Draw = "Draw",
...
export declare enum ProgressionCharacterType {
    Unknown = "Unknown",
...
export declare enum ArmorStatCalculationType {
    None = "None",
    Average = "Average",
    Add = "Add"
}
/** World.GearLayerType */
export declare enum GearLayerType {
    Unknown = "Unknown",
    Weapon = "Weapon",
    Armor = "Armor"
}
/** CU.Skills.SubpartId */
export declare enum SubpartId {
    None = "None",
...
export declare enum EquipRequirementStatus {
    Unknown = "Unknown",
...
export declare enum ItemActionUIReaction {
    None = "None",
...
export declare enum PlotContestedState {
    Invalid = "Invalid",
    Contested = "Contested",
...
export declare enum SecureTradeState {
    None = "None",
    Invited = "Invited",
...
export declare enum MapPointActionType {
    ClientCommand = "ClientCommand"
}
/** World.VoxState */
export declare enum VoxState {
    NotFound = "NotFound",
...
export declare enum VoxJobState {
    None = "None",
...
export declare enum GroupAlertKind {
    None = "None",
...
export declare enum TradeAlertKind {
    None = "None",
    NewInvite = "NewInvite",
...
export declare enum SecureTradeDoneReason {
    None = "None",
    Completed = "Completed",
    Canceled = "Canceled"
}
